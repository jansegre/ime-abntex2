...
% Apresentacao
% ime-abntex2: Modificações no modelo abntex2 para conformar com os padrões
% do IME (Instituto Militar de Engenharia).
% ------------------------------------------------------------------------
% ------------------------------------------------------------------------
...
\orientador{Beltrano Beltranoso - Ph.D.}
...
{xxxx} % esse número deve ser montado com a ajuda da biblioteca do IME
...
\imprimirfolhadeaprovacao{11 de novembro de 2013}
% ---
